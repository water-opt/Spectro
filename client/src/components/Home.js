        ...
        <div>
            ...
            <section class="about top" id="about">
                <div class="container flex">
                    <div class="left">
                        <div class="img">
                            <img src="/images/ab1.jpg" alt="" class="image1" />
                            <img src="/images/ab2.jpeg" alt="" class="image2" />
                        </div>
                    </div>
                    <div class="right">
                        <div class="heading">
            ...
            <section className='home-page'>
                <div className='banner-image 2'>
                    ...
                    <div className='banner-content1'>
                        ...
                        <br/>
                        <h2>HERES A GREAT CHANCE TO JOIN WITH OUR TEAM TO SUPPLY YOUR QUALITY PRODUCTS!!!</h2>
                        <br/>
                        <div className='d-grid gap-2 col-6 mx-auto'>
                            <button className='btn btn-danger btn-lg d-block mb-10 py-4 '>CLICK HERE</button>
                        </div>
                    </div>
